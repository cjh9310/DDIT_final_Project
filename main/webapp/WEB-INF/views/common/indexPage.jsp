					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/recruit/list.do','M010100')">채용공고</a>
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/recruit/empstats.do','M010200')">고용정보
								통계 및 동향</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/openrec/calendar.do','M020100')">공채정보
								달력</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/openrec/list.do','M020200')">공개채용정보</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/talentres/main.do','M030100')">인재관리</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/futurelab/ai1/main.do','M040100')">AI와
								함께하는 취업 탐색</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/futurelab/ai2/main.do','M040200')">AI와
								함께하는 면접 준비</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/futurelab/ai3/main.do','M040300')">다양한
								AI Service 체험하기</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/salary/list.do','M050100')">연봉
								리스트</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/salary/news.do','M050200')">연봉
								뉴스</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/salary/calculator.do','M050300')">연봉
								계산기</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/support/counsel/main.do','M060100')">취업
								상담</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/support/mentoring/list.do','M060200')">멘토링</a>
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/support/contest/list.do','M060300')">공모전</a>
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/support/tip/list.do','M060400')">TIP</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/community/publicwork/list.do','M070100')">공공근로알림</a>
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/community/faq/list.do','M070200')">자주
								묻는 질문(FAQ)</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/community/report/list.do','M070300')">신고
								게시판</a> <a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/community/archive/list.do','M070400')">서식
								자료실</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item"
								href="javascript:goPage('<%=request.getContextPath()%>/senior/list.do','M080100')">시니어
								채용공고</a>
						</div></li>
				</ul>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		...
		<div class="page-inner">
			...
			<div class="page-content-wrapper">
				...
				<main id="js-page-content" role="main" class="page-content"
					style="padding:0px;"> <iframe name="ifr" id="ifr_section"
					src="<%=request.getContextPath()%>/main.do" frameborder="0"
